...
assert.strictEqual(getCheckinThreshold("train", "小学六年级"), 300);
assert.strictEqual(getCheckinThreshold("train", "初三"), 300);
assert.strictEqual(getCheckinThreshold("train", "初中688高频词"), 300);
...
let juniorTrain = advanceDailyProgress(null, 299, 300, "2026-06-08", "2026-06-07");
assert.strictEqual(juniorTrain.todayCount, 299);
assert.strictEqual(juniorTrain.lastCheckIn, "");
juniorTrain = advanceDailyProgress(juniorTrain, 1, 300, "2026-06-08", "2026-06-07");
...
const nextDay = advanceDailyProgress(juniorTrain, 1, 300, "2026-06-09", "2026-06-08");
...
const secondCheckIn = advanceDailyProgress(nextDay, 299, 300, "2026-06-09", "2026-06-08");
