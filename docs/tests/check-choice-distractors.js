...
assert(app.includes("function englishEditDistance"), "training choices should rank near-spelling distractors as useful alternatives");
...
assert(app.includes("isEquivalentVocabularyAnswer(candidate, answer)"), "an equivalent correct answer must never be ranked as a distractor");
