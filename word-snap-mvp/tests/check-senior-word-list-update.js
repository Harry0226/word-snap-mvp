...
const expected = [
  { grade: "高一", source: "高一内置词库", count: 700, first: "acceptance", last: "involve" },
  { grade: "高二", source: "高二内置词库", count: 508, first: "backpack", last: "basin" },
...
assert(app.includes("BUILTIN_SEED_VERSION = 9"), "builtin seed version should be bumped for senior deck replacement");
assert(app.includes("Number(seedMeta?.value || 0) < 9"), "existing browsers should reseed the senior deck update");
