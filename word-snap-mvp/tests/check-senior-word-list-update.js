...
assert(app.includes("BUILTIN_SEED_VERSION = 10"), "builtin seed version should be bumped for senior deck replacement");
assert(app.includes("Number(seedMeta?.value || 0) < 10"), "existing browsers should reseed the senior deck update");
